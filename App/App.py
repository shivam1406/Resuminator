...
st.set_page_config(
   page_title="Resuminator",
   page_icon='./screenshots/Pageicon.png',
)
...
def run():
    ...
    img = Image.open('./screenshots/Icon.png')
    st.image(img)
    ...
    link = """
        <style>
            ...
            a.sidebar-link:hover {
                color: #3678f2;  /* Hover color */
            }
        </style>
        <b>Built with 🤍 by 
            <a href="https://www.linkedin.com/in/ssshivam1406/" class="sidebar-link" >Shivam</a>
        </b>
    """ 
    ...
    st.sidebar.markdown('''
        ...
        <noscript>
            <a href="https://www.freecounterstat.com" title="website hit counter">
                <img src="https://counter2.optistats.ovh/private/freecounterstat.php?c=xx2pkycllknth53r47662q9s7j3kuytf" border="0" title="website hit counter" alt="website hit counter">
            </a>
        </noscript>
    
        <p>Visitors
        <img src="https://counter2.optistats.ovh/private/freecounterstat.php?c=xx2pkycllknth53r47662q9s7j3kuytf" border="0" title="website hit counter" alt="website hit counter" width="100px">
        </p>
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.header("**About The Tool - Resuminator**")

        st.markdown('''
        <h2>Overview</h2>
        <p align="justify">
            This tool leverages Natural Language Processing (NLP) to extract information from resumes, identify key terms, 
            and group them into relevant sectors. Based on keyword matching, it provides personalized recommendations, 
            predictions, and analytics for the applicant.
        </p>
        <p align="justify">
            <h2>How to Use</h2>
            <h3>User</h3> 
            <ul>
                <li>From the sidebar, select the <strong>User</strong> option.</li>
                <li>Fill in the required details and upload your resume in PDF format.</li>
                <li>Sit back and relax—the tool will automatically process your resume and generate insights.</li>
            </ul>
            <br/>
            <h3>Feedback</h3>
            <ul>
                <li>Share your thoughts and suggestions about the tool to help us improve.</li>
            </ul>
            <h3>Admin</h3>
            <ul>
                ...
                <li>Upon login, the system will load the necessary data and perform a comprehensive analysis.</li>
            </ul>
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/ssshivam1406/" style="text-decoration: none; color: grey;">Shivam</a> 
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@123':
                ...
                st.success("Welcome Shivam ! Total %d " % values + " User's Have Used Our Tool : )")                
